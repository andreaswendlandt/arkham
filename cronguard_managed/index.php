...
<html lang="en"> 
  ...
  <div class="ui container">
    ...
    <div class="ui segment">
      ...
      Guess what will be echoed here, correct - success and with that the logic of the results for cronjobs is wrong. The reason is that            every command of a piped command chain has its own return value which is stored in a shell array variable - <i>${PIPESTATUS[*]}</i>           <br />
