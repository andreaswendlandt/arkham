...
<html lang="en"> 
  ...
  <div class="ui container">
    <h1 class="ui header">Cronguard</h1> 
    <h2 class="ui header">- Let your Cronjobs get evaluated -</h2>
    <h3 class="ui header">#What it is</h3>
    ...
    <h3 class="ui header">#What do i need</h3>
    <div class="ui segment">
    ...
    <h3 class="ui header">#What does it cost</h3>
    <div class="ui segment">
    ...
    <h3 class="ui header">#About the author</h3>
    <div class="ui segment">
